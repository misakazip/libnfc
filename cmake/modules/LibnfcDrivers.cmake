...
SET(LIBNFC_DRIVER_RCS380 ON CACHE BOOL "Enable Sony RC-S380 support (Depends on libusb)")
...
IF(LIBNFC_DRIVER_RCS380)
  FIND_PACKAGE(LIBUSB REQUIRED)
  ADD_DEFINITIONS("-DDRIVER_RCS380_ENABLED")
  SET(DRIVERS_SOURCES ${DRIVERS_SOURCES} "drivers/rcs380.c")
  SET(USB_REQUIRED TRUE)
ENDIF(LIBNFC_DRIVER_RCS380)
